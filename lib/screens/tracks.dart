...
class _MusicTracksState extends State<MusicTracks> {
  ...
  void getTracks() async {
    ...
    print(songs.length);
    // var plalists = await audioQuery.getPlaylists();
    // print(plalists);
    setState(() {
      isLoading = false;
    });
          ...
          itemBuilder: (context, e) {
            return Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    // currentIndex = e;
                    Navigator.of(context).push(_createRoute(songs, e));
                  },
                  child: Container(
                    height: 60,
...
Route _createRoute(songs, e) {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) =>
        MyMusicPlayer(songs: songs, key: UniqueKey(), currentIndex: e),
